...
flowchart TD
    ...
    F1 --> F11[AI Уточняет Оборудование, Склад, Дата Начало и Конец Аренды]
    ...
    D2 --> D3[В черновки вносятся данные об недоступном оборудовании - наименование и дата]
    D3 --> D4[Менеджер нажимает «Отправить Viber»]
    
    %% Подтверждение
    D2 --> E1[Клиент выбирает другую дату или оборудование]
    E1 --> C2
